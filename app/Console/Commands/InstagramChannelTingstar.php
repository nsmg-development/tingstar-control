...
class InstagramChannelTingstar extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrap:tingstar:instagram:channel';
     ...
     * @var string
     */
    protected $description = '인스타그램 크롤링(채널별) - 팅스타';
                        ...
                        try {
                            ...
                            if (!$article) {
                                ...
                                if($node->getImageThumbnail()['url']) {
                                    $thumbnail = $this->azureService->AzureUploadImage($node->getImageThumbnail()['url'], date('Y') . '/tingstar/images');
